...
export default ({ handleAction, id, likes, docType }) => {
  ...
  const handleLikeToggle = useCallback(
    async e => {
      ...
      if (cid) {
        ...
        try {
          ...
          handleAction && handleAction("update", { id, likes: likes });
          await http.patch(
          ...
          handleAction && handleAction("update", { id, likes });
          setSnackBar(message);
        } finally {
    ...
    [docType, handleAction, id, likes, setSnackBar, cid]
  );
